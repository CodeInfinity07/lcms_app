                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Club Name</p>
                                <h4 class="mb-0">Magneto</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Club Code</p>
                                <h4 class="mb-0">7171701</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Trophies</p>
                                <h4 class="mb-0">0</h4>
                            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Management</h4>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="javascript: void(0);" class="text-body fw-bold">#SK25</a> </td>
                                <td>Neal Matthews</td>
                                <td>
                                    <span class="badge badge-pill badge-soft-success font-size-11">Admin</span>
                                </td>
                                <td>
