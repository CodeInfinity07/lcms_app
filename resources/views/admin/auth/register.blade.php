                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="font-size-14 mb-0">- LT User</p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Get your free LT account now.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" class="form-horizontal" action="{{ route('register') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <p class="mb-0">By registering you agree to the LT <a href="#"
                                    ...
                                    <div class="mt-4 mt-md-3 text-center">
                                        <p class="mb-0">© <script>
                                            ...
                                            </script> LT. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                            Themesbrand</p>
                                    </div>
                                </div>
